    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/documents/**").hasAnyRole("ADMIN", "USER", "AREA_ADMIN")
                        .requestMatchers("/api/areas/**").hasAnyRole("ADMIN", "USER", "AREA_ADMIN")
                        .requestMatchers("/api/chat/**").hasAnyRole("ADMIN", "USER", "AREA_ADMIN")
